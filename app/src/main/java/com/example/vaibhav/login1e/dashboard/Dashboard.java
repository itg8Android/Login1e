...
public class Dashboard extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter=new DashboardPresenterImp(this,getBaseContext());
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_add_exam) {
            Intent intent = new Intent(Dashboard.this, ExamExpActivity.class);
    ...
    public void onSuccessfulDownloadMasters(boolean status) {
        if(status){
            ...
            Log.d(TAG,"data downloaded fail");
        }
    }
